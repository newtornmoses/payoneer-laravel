...
class PayoneerApi extends ApiAbstract
{
    ...
    public function getManageAccountLink()
    {
    	if($this->config->sandbox)
    		return 'https://myaccount.sandbox.payoneer.com';
     ...
     *
     * @param request\PayeeSignupRequest $request
     * @return mixed
     */
     ...
     * The token is unique and is generated by Payoneer specifically for each sign-up session.
     *
     * @param request\PayeeSignupAutoPopulationRequest $request
     * @return mixed
     */
     ...
     *
     * @param request\PerformPayoutPaymentRequest $request
     * @return mixed
     */
